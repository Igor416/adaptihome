...
export default function Home({links, isMobile}: LinksProps & ResponsiveProps) {
  const [t, i18n] = useTranslation('links')

  return <Centralizer>
    <div className='d-flex flex-column align-items-center p-4 p-sm-5 h3 text-white'>
      <SideText text='home' right='10' isMobile={isMobile} />
      {links.map((link, i) => {
